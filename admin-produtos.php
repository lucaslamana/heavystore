    ...
    <table id="texto" width="100%" border="1" bordercolor='white'>
      ...
      while ($usuario = mysql_fetch_array($sql)) {
        ...
        <tr>
          ...
          <td align="center"><?php echo $usuario["quantidade"]; ?></td>
          <td align="center">
            <a href="editar-produto.php?nome=<?php echo $usuario["nome"]; ?>&id=<?php echo $usuario["id"]; ?>"><img src="images/edit.png" width="16" height="16" border="0"></a>
            <a href="visualizar-produto.php?id=<?php echo $usuario["id"] ?>"><img src="images/view.png" width="16" height="16" border="0"></a>
            <a href="excluir-produto.php?id=<?php echo $usuario["id"]; ?>"><img src="images/delete.png" width="16" height="16" border="0"></a>
            <a href="incluir-foto.php?nome=<?php echo $usuario["nome"] ?>&id=<?php echo $usuario["id"] ?>"><img src="images/foto.png" width="20" height="20" border="0"></td>
        </tr>
            <?php } ?>
      </table>
    </div>
